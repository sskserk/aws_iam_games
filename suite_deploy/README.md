...
aws --profile awide cloudformation create-stack --stack-name staging-rodion-01 --template-body file://awide-suite-deploy-v1.0.yaml --capabilities CAPABILITY_IAM
